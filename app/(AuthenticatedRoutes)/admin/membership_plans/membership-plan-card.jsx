...
const MembershipPlanCard = ({ plan, handleEdit, handleDelete }) => {
  ...
  return (
    <>
      <Card className="bg-[#f4e8ff] rounded-md px-2 sm:px-10 py-4 min-w-full drop-shadow-md border-r-0 border-y-0 border-l-4 border-purple-500">
        ...
        {plan.features.map((feature, index) => {
          return (
            <li key={index} className="text-gray-700 list-decimal">
              {feature}
            </li>
          );
        })}
        <div className="flex justify-between">
          ...
          <h2 className="font-normal text-gray-700 flex items-center gap-2 ">
